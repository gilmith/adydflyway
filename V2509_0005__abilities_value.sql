...
IF(COUNTER = 0) THEN
	INSERT INTO adyd_tablas.abilities
	(id, NAME, hit_dice, strength_minimun, dexterity_minimum, intelligence_minimum, wisdom_minimum, charisma_minimum, constitution_minimum, weapon_proficiences_points, no_weapon_proficiences_points)
